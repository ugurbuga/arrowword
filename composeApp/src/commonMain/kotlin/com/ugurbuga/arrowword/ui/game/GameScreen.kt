...
import com.ugurbuga.arrowword.generated.resources.clue_marker_down
import com.ugurbuga.arrowword.generated.resources.clue_marker_right
import com.ugurbuga.arrowword.generated.resources.congrats_dialog_message
import com.ugurbuga.arrowword.generated.resources.congrats_dialog_title
...
private fun GameScreenDialogs(
    ...
    if (isCongratsDialogOpen) {
        AlertDialog(
            ...
            title = { Text(text = stringResource(Res.string.congrats_dialog_title)) },
            text = { Text(text = stringResource(Res.string.congrats_dialog_message)) },
            confirmButton = {
                TextButton(onClick = onNextLevel, enabled = !isLoading) {
                    Text(text = stringResource(Res.string.next_level))
                }
            },
            dismissButton = {
...
private fun PuzzleCell(
    ...
    fun normalizeTrUppercaseChar(c: Char): Char {
        return when (c) {
            'i' -> 'İ'
            'ı' -> 'I'
        ...
        when (cell) {
            ...
            is Cell.Clue -> {
                val marker = when (cell.direction) {
                    Direction.RIGHT -> stringResource(Res.string.clue_marker_right)
                    Direction.DOWN -> stringResource(Res.string.clue_marker_down)
                }
