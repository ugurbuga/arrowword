...
class GameViewModel(
    ...
    private fun normalizeTrUppercaseChar(c: Char): Char {
        return when (c) {
            'i' -> 'İ'
            'ı' -> 'I'
    ...
    private fun isSolved(puzzle: Puzzle, entries: CharArray): Boolean {
        ...
        for (i in puzzle.cells.indices) {
            ...
            if (cell is Cell.Letter) {
                ...
                if (normalizeTrUppercaseChar(entered) != normalizeTrUppercaseChar(cell.solution)) return false
            }
        }
        return true
    }
        ...
        for (i in puzzle.cells.indices) {
            ...
            if (cell is Cell.Clue) {
                ...
                val isCorrect = indices.all { idx ->
                    ...
                    entered != '\u0000' && normalizeTrUppercaseChar(entered) == normalizeTrUppercaseChar(solution)
                }
